...
//     connectCustomerToAgent(by: By, agentAddress: builder.IAddress): Promise<IConversation>;
//     connectCustomerToBot(by: By): Promise<boolean>;
//     queueCustomerForAgent(by: By): Promise<boolean>;

//     // Get
//     getConversation(by: By, customerAddress?: builder.IAddress): Promise<IConversation>;
...
//     public connectCustomerToAgent = async (by: By, agentAddress: builder.IAddress): Promise<IConversation> => {
...
//     public getConversation = async (by: By, customerAddress?: builder.IAddress): Promise<IConversation> => {
//         return await this.provider.getConversation(by, customerAddress);
//     }

//     public getCurrentConversations = async (): Promise<IConversation[]> => {
